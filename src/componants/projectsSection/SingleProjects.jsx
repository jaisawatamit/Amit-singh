...
function SingleProjects({ name, year, align, image, link }) {
    return (
        <motion.div
      ...
      viewport={{ once: false, amount: 0.1 }} 
        className={`flex w-full sm:flex-col-reverse items-center gap-8 ${
            ...
            <div className="max-h-[240px] max-w-[400px] rounded-xl overflow-hidden hover:scale-110 transform transition-all duration-500 ralative border border-white">
